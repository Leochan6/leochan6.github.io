...
var memoria_collection = [{
  ...
  "naname": "Dive into Summer (Amane Sisters)",
  "type": "ability",
  "rank": "4",
  "min_hp": "731",
  "min_atk": "882",
  ...
  "naname": "Dive into Summer (Alina & Mifuyu)",
  "type": "skill",
  "rank": "3",
  "min_hp": "613",
  "min_atk": "0",
...
var startUp = function startUp() {
  ...
  (0, _toConsumableArray2["default"])(_memoria_collection.memoria_collection).filter(function (memoria) {
    return memoria.naname;
  }).sort(function (a, b) {
    return a.naname > b.naname ? 1 : -1;
  }).forEach(function (memoria) {
    _memoria_elements.memoria_elements.name_select.options.add(new Option(memoria.naname, memoria.id, false));
  });
...
var minimizeDisplay = function minimizeDisplay() {
  ...
  var display = new Display(memoria.id, memoria.naname, memoria.type, memoria.rank, "0", "1", _memoria_elements.memoria_elements.archive_checkbox.checked, _memoria_elements.memoria_elements.protect_checkbox.checked);
  updateForm(display);
...
var maximizeDisplay = function maximizeDisplay() {
  ...
  var display = new Display(memoria.id, memoria.naname, memoria.type, memoria.rank, "4", getMaxLevel("4", memoria.rank), _memoria_elements.memoria_elements.archive_checkbox.checked, _memoria_elements.memoria_elements.protect_checkbox.checked);
  updateForm(display);
  updatePreviewDisplay(display);
};
/**
...
var filterMemoria = function filterMemoria(search) {
  ...
  Array.from(memoriaSelectModalList.children).forEach(function (child) {
    ...
    if (memoria.id.includes(search) || memoria.name.toLowerCase().includes(search) || memoria.naname.toLowerCase().includes(search) || memoria.type.toLowerCase().includes(search) || memoria.rank.toLowerCase().includes(search) || memoria.chara && memoria.chara.toLowerCase().includes(search) || memoria.effect1 && memoria.effect1.toLowerCase().includes(search) || memoria.effect2 && memoria.effect2.toLowerCase().includes(search) || memoria.obtainability.includes(search)) {
      child.classList.remove("hidden");
      child.style.display = "inline-block";
    } else {
      child.classList.add("hidden");
...
var openMemoriaDialog = function openMemoriaDialog(memoria, displays) {
  ...
  _memoria_elements.messageDialog.open("".concat(memoria.naname, " Details"), text);
};
