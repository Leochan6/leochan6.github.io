import { memoria_elements as elements } from './memoria_elements.js';
...
export const setProfiles = (profiles, previous) => {
  ...
  if (selectedProfile !== null && selectedProfile.name !== null) {
    ...
    let listId = memoria_list_api.getListId();
    if (listId) storage_api.updateListProfile(listId, "10");
  }
...
export const deleteProfile = () => {
  ...
  if (storage_api.profiles[profileId].name !== "Default" && storage_api.profiles[profileId].name !== "Custom") {
    ...
    selectedProfile = { name: "Default", id: "10" };
    elements.profile_select.value = "10";
    let listId = memoria_list_api.getListId();
...
export const changeToCustom = () => {
  elements.profile_select.value = "11";
};
